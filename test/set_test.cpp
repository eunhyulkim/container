...
int set_test_main(void)
{
    /* iterator test */
    {
        ...
        ft::Set<Myclass> *con = new ft::Set<Myclass>;
        for (int i = 0; i < 20; i++) {
            con->insert(data[i % 10]);
        }
        ft::Set<Myclass>::const_iterator it_const = static_cast<const ft::Set<Myclass> *>(con)->begin();
        ret[6] = ret[7] = (*it_const).get_m_name() == "eight";
        ret[8] = it_const->get_m_name() == "eight";
        ft::Set<Myclass>::iterator it_default = con->begin();
        ret[0] = true;
        ft::Set<Myclass>::iterator it_param(it_default.as_node());
        ret[1] = it_param->get_m_name() == "eight";
        ft::Set<Myclass>::iterator it_copy(it_param);
        ret[2] = it_copy->get_m_name() == "eight";
        ft::Set<Myclass>::iterator it_assign((con->begin() + 1).as_node());
        it_default = it_assign;
        ret[5] = ret[3] = (*it_default).get_m_name() == "five";
        ret[9] = (++it_default)->get_m_name() == "four";
        ret[10] = (it_default++)->get_m_name() == "four";
        ret[10] = (ret[10] == true && it_default->get_m_name() == "nine") ? true : false;
        ret[11] = (--it_default)->get_m_name() == "four";
        ret[12] = (it_default--)->get_m_name() == "four";
        ret[12] = (ret[12] == true && it_default->get_m_name() == "five") ? true : false;
        ret[13] = (*(it_default + 2)).get_m_name() == "nine";
        ret[13] = (ret[13] == true && (*it_default).get_m_name() == "five") ? true : false;
        it_default += 2;
        ret[14] = (*it_default).get_m_name() == "nine";
        ret[15] = (*(it_default - 2)).get_m_name() == "five";
        ret[15] = (ret[15] == true && (*it_default).get_m_name() == "nine") ? true : false;
        it_default -= 2;
        ret[16] = ((*it_default).get_m_name() == "five");
    ...
    /* reverse iterator test */
    {
        ...
        ft::Set<Myclass>::const_reverse_iterator it_const = static_cast<const ft::Set<Myclass> *>(con)->rbegin();
        ret[6] = ret[7] = (*it_const).get_m_name() == "zero";
        ret[8] = it_const->get_m_name() == "zero";
        ft::Set<Myclass>::reverse_iterator it_default = con->rbegin();
        ret[0] = true;
        ft::Set<Myclass>::reverse_iterator it_param(it_default.as_node());
        ret[1] = it_param->get_m_name() == "zero";
        ft::Set<Myclass>::reverse_iterator it_copy(it_param);
        ret[2] = it_copy->get_m_name() == "zero";
        ft::Set<Myclass>::reverse_iterator it_assign((con->rbegin() + 1).as_node());
        it_default = it_assign;
        ret[5] = ret[3] = (*it_default).get_m_name() == "two";
        ret[9] = (++it_default)->get_m_name() == "three";
        ret[10] = (it_default++)->get_m_name() == "three";
        ret[10] = (ret[10] == true && it_default->get_m_name() == "six") ? true : false;
        ret[11] = (--it_default)->get_m_name() == "three";
        ret[12] = (it_default--)->get_m_name() == "three";
        ret[12] = (ret[12] == true && it_default->get_m_name() == "two") ? true : false;
        ret[13] = (*(it_default + 2)).get_m_name() == "six";
        ret[13] = (ret[13] == true && (*it_default).get_m_name() == "two") ? true : false;
        it_default += 2;
        ret[14] = (*it_default).get_m_name() == "six";
        ret[15] = (*(it_default - 2)).get_m_name() == "two";
        ret[15] = (ret[15] == true && (*it_default).get_m_name() == "six") ? true : false;
        it_default -= 2;
        ret[16] = ((*it_default).get_m_name() == "two");
        ret[17] = (it_default != it_default) ? false : true;
        ret[18] = (it_default == it_default) ? true : false;
        ret[19] = it_default > (it_default + 1);
        ret[20] = it_default <= it_default;
    ...
    /* container test */
    {
        ...
        con->insert(data[4]);
        con->insert(data[2]);
        ret[24] = ret[0] = con->size() == 2 && con->find(data[4]) == con->begin();
        ...
        /* copy constructor */
        ft::Set<Myclass> conCopy(*con);
        ret[3] = conCopy.begin()->get_m_name() == "five";

        /* iterator constructor */
        ft::Set<Myclass> conIter(con->begin(), con->end());
        ret[2] = conIter.begin()->get_m_name() == "five";

        /* assign operator */
        ft::Set<Myclass> conAssign;
        ...
        /* swap */
        ft::Set<Myclass> conTwo;
        ft::Set<Myclass> conThree;
